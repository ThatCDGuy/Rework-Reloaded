...
if (
	abs(distance_to_object(obj_player1)) < 25
	&& !place_meeting(x, y, obj_destructibles)
	&& !place_meeting(x, y, obj_iceblock_breakable)
	&& !place_meeting(x, y, obj_iceblock)
	&& !place_meeting(x, y, obj_ghostblock)
) {
	if (!gotowardsplayer) {
