...
function fakepep_set_attack(phase, wastedhits, _attack, _cooldown, _deformed_timer) {
	...
	attack_list[phase][wastedhits] = {attack: _attack, cooldown: _cooldown, deformed_timer: _deformed_timer};
}
...
function fakepep_add_grabclone(phase, wastedhits, _direction, _cooldown) {
	fakepep_add_projectile(phase, wastedhits, {attack: fakepep_attacks.grabclone, cooldown: _cooldown, direction: _direction});
}

function fakepep_add_bodyslamclone(phase, wastedhits, _direction, _cooldown) {
	fakepep_add_projectile(phase, wastedhits, {attack: fakepep_attacks.bodyslamclone, cooldown: _cooldown, direction: _direction});
}

function fakepep_add_machclone(phase, wastedhits, _direction, _cooldown, _bodyslam) {
	fakepep_add_projectile(phase, wastedhits, {attack: fakepep_attacks.machclone, cooldown: _cooldown, direction: _direction, bodyslam: _bodyslam});
}
...
function fakepep_add_superjumpclones(phase, wastedhits, _direction, _timer, _size, _emptyspot, _cooldown, _x1 = 100, _x2 = 850, _y = 402) {
	...
	fakepep_add_projectile(
		phase,
		wastedhits,
		{attack: fakepep_attacks.superjumpclone, cooldown: _cooldown, direction: _direction, timer: _timer, size: _size, emptyspot: _emptyspot, x1: _x1, x2: _x2, y: _y}
	);
}

function fakepep_add_flailingclone(phase, wastedhits, _direction, _cooldown, _x1 = 100, _x2 = 850, _y = 402) {
	fakepep_add_projectile(phase, wastedhits, {attack: fakepep_attacks.flailingclone, cooldown: _cooldown, direction: _direction, x1: _x1, x2: _x2, y: _y});
}

function fakepep_add_tauntclones(phase, wastedhits, _vsp1, _vsp2, _cooldown, _x1 = 125, _x2 = 825, _y = 402) {
	fakepep_add_projectile(phase, wastedhits, {attack: fakepep_attacks.tauntclone, cooldown: _cooldown, vsp1: _vsp1, vsp2: _vsp2, x1: _x1, x2: _x2, y: _y});
}
