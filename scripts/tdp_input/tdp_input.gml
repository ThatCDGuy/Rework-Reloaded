...
function tdp_action(_type, _value, _joystick_direction = 0) {
	return {type: _type, value: _value, joystick_direction: _joystick_direction};
}
	...
	switch (argument0.type) {
		case tdp_input.keyboard:
			switch (argument0.value) {
				...
				case vk_rshift:
				case vk_lshift:
					return {sprite_index: spr_tutorialkeyspecial, image_index: 0, str: ""};
				case vk_control:
				case vk_lcontrol:
				case vk_rcontrol:
					return {sprite_index: spr_tutorialkeyspecial, image_index: 1, str: ""};
				case vk_space:
					return {sprite_index: spr_tutorialkeyspecial, image_index: 2, str: ""};
				case vk_up:
					return {sprite_index: spr_tutorialkeyspecial, image_index: 3, str: ""};
				case vk_down:
					return {sprite_index: spr_tutorialkeyspecial, image_index: 4, str: ""};
				case vk_right:
					return {sprite_index: spr_tutorialkeyspecial, image_index: 5, str: ""};
				case vk_left:
					return {sprite_index: spr_tutorialkeyspecial, image_index: 6, str: ""};
				case vk_escape:
					return {sprite_index: spr_tutorialkeyspecial, image_index: 7, str: ""};
				default:
					return {sprite_index: spr_tutorialkey, image_index: 0, str: scr_keyname(argument0.value)};
			}
			break;
		...
		case tdp_input.gamepad:
			switch (argument0.value) {
				case gp_face1:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 0, str: ""};
				case gp_face2:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 1, str: ""};
				case gp_face3:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 2, str: ""};
				case gp_face4:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 3, str: ""};
				case gp_shoulderlb:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 4, str: ""};
				case gp_shoulderrb:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 5, str: ""};
				case gp_shoulderr:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 6, str: ""};
				case gp_shoulderl:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 7, str: ""};
				case gp_stickl:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 8, str: ""};
				case gp_stickr:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 9, str: ""};
				case gp_padu:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 10, str: ""};
				case gp_padr:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 11, str: ""};
				case gp_padd:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 12, str: ""};
				case gp_padl:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 13, str: ""};
				case gp_start:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 14, str: ""};
				case gp_select:
					return {sprite_index: global.spr_gamepadbuttons, image_index: 15, str: ""};
			}
			break;
			...
			switch (argument0.value) {
				case gp_axislh:
					if (argument0.joystick_direction == -1) {
						return {sprite_index: global.spr_joystick, image_index: 0, str: ""};
					}
					if (argument0.joystick_direction == 1) {
						return {sprite_index: global.spr_joystick, image_index: 1, str: ""};
					}
					break;
				case gp_axislv:
					if (argument0.joystick_direction == -1) {
						return {sprite_index: global.spr_joystick, image_index: 2, str: ""};
					}
					if (argument0.joystick_direction == 1) {
						return {sprite_index: global.spr_joystick, image_index: 3, str: ""};
					}
					break;
				case gp_axisrh:
					if (argument0.joystick_direction == -1) {
						return {sprite_index: global.spr_joystick, image_index: 4, str: ""};
					}
					if (argument0.joystick_direction == 1) {
						return {sprite_index: global.spr_joystick, image_index: 5, str: ""};
					}
					break;
				case gp_axisrv:
					if (argument0.joystick_direction == -1) {
						return {sprite_index: global.spr_joystick, image_index: 6, str: ""};
					}
					if (argument0.joystick_direction == 1) {
						return {sprite_index: global.spr_joystick, image_index: 7, str: ""};
					}
					break;
			}
			break;
