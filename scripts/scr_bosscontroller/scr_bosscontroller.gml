function scr_bosscontroller_particle_hp(sprite, image, x, y, hsp, spr_palette, paletteselect, palettetexture = noone) {
	with (obj_bosscontroller) {
		var q = {type: 0, sprite_index: sprite, image_index: image, x: x, y: y, hsp: 8 * hsp, vsp: -6, spr_palette: spr_palette, paletteselect: paletteselect, palettetexture: palettetexture};
...
function scr_bosscontroller_particle_anim(sprite, image, x, y, imagespeed, spr_palette = spr_peppalette, paletteselect = 0) {
	with (obj_bosscontroller) {
		var q = {type: 1, sprite_index: sprite, image_index: image, image_speed: imagespeed, x: x, y: y, spr_palette: spr_palette, paletteselect: paletteselect};
		ds_list_add(particlelist, q);
		return q;
	}
}
...
function scr_bosscontroller_normal() {
	...
	if (
		!instance_exists(bossID)
		&& !bossdead
		&& instance_exists(obj_player1)
		&& obj_player1.state != states.tackle
