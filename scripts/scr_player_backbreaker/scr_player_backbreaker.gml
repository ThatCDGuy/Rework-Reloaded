function scr_player_backbreaker() {
	...
	if (
		...
		if (
			supercharged == 1
			&& (sprite_index == spr_supertaunt1 || sprite_index == spr_supertaunt2 || sprite_index == spr_supertaunt3 || sprite_index == spr_supertaunt4 || sprite_index == spr_player_ratmountsupertaunt)
			&& !instance_exists(obj_tauntaftereffectspawner)
		) {
		...
		if (
			input_taunt_p2 > 0
			|| (global.swapmode && obj_inputAssigner.player_input_device[!obj_inputAssigner.player_index] == obj_inputAssigner.player_input_device[obj_inputAssigner.player_index] && key_down2)
		) {
