function scr_player_knightpep() {
	...
	var dj = true;
	if (
		(input_buffer_jump > 0 && vsp > 0)
		&& can_jump
		&& (sprite_index == spr_knightpepidle || sprite_index == spr_knightpepdowntrust || sprite_index == spr_knightpepland || sprite_index == spr_knightpepwalk || sprite_index == spr_knightpepfall)
	) {
	...
	if (
		(floor(image_index) == image_number - 1 && sprite_index == spr_knightpepjump)
		|| (
			!grounded
				&& sprite_index != spr_knightpepjumpstart
				&& sprite_index != spr_knightpepjump
				...
				&& sprite_index != spr_knightpepdowntrust
				&& sprite_index != spr_knightpepdoublejump
				&& sprite_index != spr_playerN_knightdoublejumpfall
		)
	) {
		sprite_index = spr_knightpepfall;
	}
	if (
		(sprite_index == spr_knightpepdowntrust || sprite_index == spr_knightpepfall || sprite_index == spr_knightpepdoublejump || sprite_index == spr_playerN_knightdoublejumpfall)
		&& grounded
		&& vsp > 0
		&& !scr_slope()
	) {
